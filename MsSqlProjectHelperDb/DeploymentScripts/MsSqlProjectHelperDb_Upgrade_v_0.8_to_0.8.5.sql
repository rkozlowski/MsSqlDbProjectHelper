/*
Deployment script for MsSqlProjectHelperDb (upgrade from v0.8 to v0.8.5)
...
ALTER TABLE [dbo].[ProjectEnum]
    ADD [NameColumn] NVARCHAR (128) NULL;
...
GO
PRINT N'Altering Table [Enum].[Language]...';
...
GO
GO
UPDATE [Enum].[Language]
SET [Code]='CSharp' WHERE [Name]='c#';
GO
ALTER TABLE [Enum].[Language]
...
GO
PRINT N'Altering Function [DbInfo].[GetCurrentVersion]...';


GO

ALTER FUNCTION [DbInfo].[GetCurrentVersion]
(	
)
RETURNS VARCHAR(50)
AS
