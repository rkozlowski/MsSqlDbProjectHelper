/*
Deployment script for MsSqlProjectHelperDb (upgrade from v0.4 to v0.5)
...
DECLARE @expectedVersion VARCHAR(50) = '0.4';
DECLARE @newVersion VARCHAR(50) = '0.5';
...
GO
PRINT N'Dropping Function [Internal].[GetName]...';


GO
DROP FUNCTION [Internal].[GetName];
...
GO
ALTER TABLE [dbo].[Project] DROP COLUMN [GenerateStaticClass], COLUMN [TreatOutputParamAsInputOutput];
