/*
Deployment script for MsSqlProjectHelperDb (v0.5.2)
...
GO
PRINT N'Creating Table [Flag].[CodeGenOption]...';
...
CREATE TABLE [Flag].[CodeGenOption] (
    ...
    [Name]        VARCHAR (50) NOT NULL,
    [IsSingleBit] BIT          NOT NULL,
    CONSTRAINT [PK_CodeGenOption] PRIMARY KEY CLUSTERED ([Value] ASC)
);


GO
PRINT N'Creating Index [Flag].[CodeGenOption].[UX_CodeGenOption_Name]...';
...
GO
PRINT N'Creating Table [dbo].[LanguageNameCasing]...';
...
GO
PRINT N'Creating Index [dbo].[LanguageNameCasing].[UX_LanguageNameCasing_LanguageId_NameTypeId]...';
...
GO
PRINT N'Creating Default Constraint [Flag].[DF_CodeGenOption_IsSingleBit]...';


GO
ALTER TABLE [Flag].[CodeGenOption]
    ADD CONSTRAINT [DF_CodeGenOption_IsSingleBit] DEFAULT ((1)) FOR [IsSingleBit];
...
GO
PRINT N'Creating Default Constraint [dbo].[DF_Template_LanguageOptions]...';
...
GO
PRINT N'Creating Foreign Key [dbo].[FK_LanguageNameCasing_Casing]...';


GO
ALTER TABLE [dbo].[LanguageNameCasing] WITH NOCHECK
    ADD CONSTRAINT [FK_LanguageNameCasing_Casing] FOREIGN KEY ([CasingId]) REFERENCES [Enum].[Casing] ([Id]);


GO
PRINT N'Creating Foreign Key [dbo].[FK_LanguageNameCasing_Language]...';
...
GO
PRINT N'Creating Foreign Key [dbo].[FK_LanguageNameCasing_NameType]...';
...
END
GO
PRINT N'Creating Function [Internal].[GetCodeGenerationOptions]...';
...
ALTER TABLE [dbo].[LanguageNameCasing] WITH CHECK CHECK CONSTRAINT [FK_LanguageNameCasing_Casing];

ALTER TABLE [dbo].[LanguageNameCasing] WITH CHECK CHECK CONSTRAINT [FK_LanguageNameCasing_Language];

ALTER TABLE [dbo].[LanguageNameCasing] WITH CHECK CHECK CONSTRAINT [FK_LanguageNameCasing_NameType];
